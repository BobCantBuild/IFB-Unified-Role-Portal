(function () {
  ...
  const PROG_DESC = {
    ...
    "Start/Pause (Program Interrupt)": "Allows the user to pause an ongoing wash cycle at any point and resume it without losing programme settings — useful for adding forgotten garments mid-cycle while the machine safely holds all parameters in memory.",
