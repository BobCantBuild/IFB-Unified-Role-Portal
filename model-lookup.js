...
(function () {
  ...
  const FL_DESC = {
   "Cotton Normal/ Cotton Eco Plus": "Cotton colour-fast garments such as shirts, pants, uniforms, bed and table linen, towels, nightdresses, pyjamas, underwear, etc. An energy-efficient cotton wash for lightly to normally soiled cotton items. Achieves effective cleaning at lower temperatures, reducing electricity and water consumption.",
    ...
    "Cotton Normal/Cotton Eco": "Standard cotton wash for colour-fast garments, with an eco variant option for lightly soiled loads ÔÇö reduces energy and water consumption without compromising cleanliness.",
    ...
    "Mix Soiled 40": "Various types of cotton, synthetic or easy-care garments washed at 40┬░C ÔÇö balances effective cleaning with energy efficiency.",
    ...
    "Express 15": "Lightly soiled coloured laundry made of cotton, linen, synthetic or blended fabrics. Completed in 15 minutes ÔÇö the fastest programme available.",
    ...
    "Daily Wear": "A balanced programme for normally soiled everyday clothing such as casual shirts, trousers, and mixed fabrics ÔÇö efficient use of water and energy.",
    "Quick 30": "A condensed 30-minute wash for small loads of lightly soiled clothes or recently worn garments.",
    "Quick Wash 30": "A condensed 30-minute wash for small loads of lightly soiled clothes or recently worn garments ÔÇö delivers a fast, effective clean without a full cycle.",
    "Spin Dry/Drain": "A standalone water-extraction cycle that spins laundry at high speed to remove residual water, or drains remaining water from the drum ÔÇö no washing involved.",
    "Additives/Rinse + Spin": "An extra rinse cycle followed by a full spin to thoroughly flush out detergent or fabric-softener residues ÔÇö especially useful for people with sensitive skin.",
    ...
    "Hot Rinse": "Introduces warm water during the rinse phase to more thoroughly dissolve and remove residual detergent from fabric fibres, while also helping sanitise garments ÔÇö particularly beneficial for baby clothes and underwear.",
    ...
    "Start/Pause": "Allows the user to pause an ongoing wash cycle at any point and resume it without losing programme settings ÔÇö useful for adding forgotten garments mid-cycle while the machine safely holds all parameters in memory.",
    "Start/Pause (Program Interrupt)": "Allows the user to pause an ongoing wash cycle at any point and resume it without losing programme settings ÔÇö useful for adding forgotten garments mid-cycle while the machine safely holds all parameters in memory.",
