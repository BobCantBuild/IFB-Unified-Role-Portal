...
(function () {
  ...
  "CradleWash": "Gentle cradle-like drum movement for delicate fabrics — silk, satin, lingerie, and hand-wash-only garments.",
  ...
  "Mix/Daily 60'": "Cotton, synthetic and easy-care garments washed over a longer 60-minute cycle for deeper cleaning.",
  ...
  "Express 30'": "Lightly soiled laundry completed in 30 minutes.",
  "Express 15'": "Lightly soiled laundry completed in 15 minutes.",
  ...
  "Bulky": "Machine washable large oversized items like blankets and bedding covers.",
  ...
  "3D Wash": "3D dynamic water jets and drum rotation work together to dissolve detergent, loosen tough dirt and rinse it away.",
  "4D Wash": "Jets of water and showers from paddles ensure complete soaking. Detergent solution gets injected into clothes for the best wash.",
  ...
  "3D/4D Wash": "Combined 3D or 4D wash system depending on model for deep cleaning.",
  "3D Wash System": "3D dynamic water jets and drum rotation work together for a deep clean.",
  ...
  "9 Swirl®": "Nine-directional swirl wash action — registered IFB technology for deep fabric cleaning.",
  ...
  "Auto Imbalance System": "Automatically detects and corrects load imbalance by adding water to redistribute clothes.",
  "Auto Foam Control System": "Detects excess foam and automatically adds an extra rinse to remove it completely.",
  "Auto Tub Clean": "Automatically alerts and runs a tub cleaning cycle to maintain hygiene and prevent odour build-up.",
  ...
  "CradleWash®": "Registered IFB technology — cradle-like drum motion for safe washing of delicate fabrics.",
  "Cradlewash": "Gentle drum motion designed to protect delicate fabrics during washing.",
  ...
  "Crescent Moon Drum": "The crescent moon drum design cushions the wash with water to protect fabric integrity.",
  "Cool Down Cycle": "Gradually reduces wash temperature at the end of the cycle to protect heat-sensitive fabrics.",
  "Drum Lamp": "LED light inside the drum for easy loading and unloading in low-light conditions.",
  "High-Low Voltage Protection": "Monitors voltage and stops the program if it goes below 165V or above 270V to protect components.",
  "Hot Rinse": "Rinses laundry in warm water to remove detergent residues and allergens more effectively.",
  ...
  "Anti-Allergen": "High-temperature wash with extra rinses to remove dust mites, pollen and allergens from fabrics.",
  "Active Wear/Sports wear": "Specially designed for gym and sportswear — removes sweat and odour while protecting performance fabric.",
  "Start/Pause": "Allows you to pause mid-cycle to add forgotten laundry, then resume without restarting.",
  "Start/Pause (Program Interrupt)": "Pause the cycle at any point to add or remove garments, then continue from where it left off.",
  ...
  "Woollens": "Machine washable woollen garments — gentle drum action and cool temperatures preserve wool's natural properties.",
  ...
  "Bulky/ Bedding": "Machine washable oversized items — blankets, duvets and bedding covers.",
  ...
  "Mixed Soiled/Mixed Solid": "Mixed load wash for moderately to heavily soiled garments of various fabric types.",
  ...
  "Cotton Normal/ Cotton Eco Plus": "Standard cotton wash or eco-plus option for colour-fast garments.",
  "Cotton Normal/Cotton Eco": "Standard cotton wash for colour-fast garments with an eco option for lightly soiled loads.",
  "Cotton Normal/Cotton Eco Plus": "Standard cotton wash for colour-fast garments combined with eco-plus for lightly soiled loads.",
  "Cotton Normal/Cotton Eco Plus/Uniform": "Standard or eco cotton wash also covering uniforms and work wear.",
  ...
  "Express 15": "Lightly soiled coloured laundry. Completed in 15 minutes — fastest available cycle.",
  "Express 15'/Express 30": "Lightly soiled laundry in 15 or 30 minutes.",
  "Express 30": "Lightly soiled laundry completed in 30 minutes.",
  ...
  "Powered by Ai": "The intuitive sensing logic in the machine detects the load, optimises water level and optimises wash program automatically for best care and efficient washing.",
  ...
  "3D Wash": "3D dynamic water jets and Tri Axial clothes rotation dissolve detergent thoroughly and remove tough dirt effectively.",
  "4D Wash": "Jets of water and paddle showers ensure complete soaking and deep detergent penetration for the best wash.",
  "Crescent Moon Drum": "The crescent moon drum design cushions the wash and protects the fabric.",
  ...
  "Auto Tub Clean": "Automatically ensures tub hygiene after the wash.",
  "High-Low Voltage Protection": "Continuously monitors voltage fluctuations and resumes operation once voltage becomes safe.",
  "Program Memory Backup": "Remembers the program after power failure and resumes from the same point.",
  "Program Memory": "Automatically balances clothes inside the tub to stabilise the spin cycle.",
  "Auto Imbalance System": "Detects unbalanced clothes and redistributes them for stable spinning.",
  "Child Lock": "Locks the machine settings and prevents accidental changes by children.",
  ...
  "Auto Restart": "Automatically resumes the wash cycle after power restoration.",
  ...
  "Baby Wear (7 Kg/8 Kg)": "High-temperature wash with extra rinses for baby clothes — available on 7 and 8 kg capacity models.",
  "Blankets": "Dedicated cycle for machine washable blankets with enhanced wash movement and controlled spin.",
  ...
  "Rinse+Spin": "Combined rinse and spin for quick freshening or removing detergent residue.",
  "STAINFIGHTER™": "Uses high temperature water to remove tough stains effectively.",
  ...
  "StainFighterTM": "Uses high temperature water to remove tough stains effectively.",
  ...
  "Delay": "Delays the start of the wash cycle to a preferred later time for added scheduling convenience.",
  ...
  "Aroma": "A refreshing aroma wash cycle that uses fragrance to leave clothes smelling fresh after washing.",
  ...
  "3D Wash": "3D dynamic water jets and drum rotation work together to dissolve detergent, loosen dirt and rinse it away.",
  "9 Swirl": "Nine-directional swirl wash action for superior dirt removal across all fabric surfaces.",
  "AI Dos": "Automatically dispenses the correct amount of detergent based on load weight and soil level.",
  "Anti Crease": "Periodically rotates the drum after the cycle ends to prevent wrinkles until you unload.",
  "Aqua Energie": "Energises water molecules to carry detergent deep into fabric fibres for a thorough wash.",
  "Auto Foam Control System": "Detects excess foam and adds an extra rinse cycle to remove it completely.",
  "Auto Imbalance System": "Detects and corrects load imbalance by redistributing clothes for a stable spin cycle.",
  "Auto Tub Clean": "Runs a cleaning cycle to remove impurities, bacteria and odours from the drum automatically.",
  "BLDC Motor Technology": "Brushless DC motor for high efficiency, low noise, minimal vibration and longer life.",
  "Child Lock": "Locks machine settings to prevent children from accidentally changing or interrupting the cycle.",
  "Crescent Moon Drum": "The crescent moon drum design cushions the wash with water to protect fabric integrity.",
  "Drum Lamp": "LED light inside the drum for easy loading and unloading in low-light conditions.",
  ...
  "Laundry Add": "Pause the cycle in the early stage to add forgotten items, then resume without restarting.",
  "Powered by Ai": "AI-driven sensing detects load, optimises water level and selects the best wash program automatically.",
  "Program Memory Backup": "Remembers the exact cycle position and resumes after a power failure without wasting water or time."
};
